                ...
                <div className="container-fluid">
                    <div className="row">
                            ...
                            <div className="card">
                                <div className="card-header border-0">
                                    ...
                                    <div className="card-tools">
                                        <a href="fake_url" className="btn btn-tool btn-sm">
                      ...
                      12,000 Sold
                                                ...
                                                <td>
                                                    <a href="fake_url" className="text-muted">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="card">
                                <div className="card-header border-0">
                                    ...
                                    <div className="card-tools">
                                        <a href="fake_url" className="btn btn-sm btn-tool">
                                            <i className="fas fa-download" />
                                        </a>
                                        <a href="fake_url" className="btn btn-sm btn-tool">
                                            <i className="fas fa-bars" />
